...
if __name__ == "__main__":
    ...
    # print(stride, names)
    #
    # im0 = cv2.imread("h0_C01JK027_20230209090201.jpg")  # BGR
    ...
    # conf_thres, iou_thres, classes, agnostic_nms, max_det = 0.7, 0.45, None, True, 20
